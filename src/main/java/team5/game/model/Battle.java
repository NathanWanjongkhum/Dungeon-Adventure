...
public class Battle {
     ...
     */
    private void addAttackText(final DungeonCharacter theAttacker, final DungeonCharacter theDefender,
            final int theDamage) {
     ...
     * 
     * @param theCharacter the dungeon character whose status condition needs to be
     *                     checked
     */
    private void checkStatus(final DungeonCharacter theCharacter) {
        if (theCharacter.getStatusEffects().isVulnerable()) {
            ...
            theCharacter.getStatusEffects()
                    .setVulnerableDuration(theCharacter.getStatusEffects().getVulnerableDuration() - 1);
        ...
        if (theCharacter.getStatusEffects().isDamageIncrease()) {
            ...
            theCharacter.getStatusEffects()
                    .setDamageDuration(theCharacter.getStatusEffects().getDamageIncreaseDuration() - 1);
    ...
    /**
     * Checks if character has a damage increase and updates if needed
     * 
     * @param theCharacter the dungeon character whose status condition needs to be
     *                     checked
     */
    ...
    /**
     * Checks if hp is below 0, in which would be set to 0 and add text if battle is
     * over.
     * 
     * @param theAttacker the attacking character
     * @param theDefender the defending character
    ...
    /**
     * Resets the effects of the character
     * 
     * @param theCharacter the character whose effects need to be reset
     */
